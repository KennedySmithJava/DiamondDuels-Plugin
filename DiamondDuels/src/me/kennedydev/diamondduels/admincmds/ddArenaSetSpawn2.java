...
public class ddArenaSetSpawn2 {

	public ddArenaSetSpawn2(String arenaName, Player sender) {
		...
		Arenas.setSpawn2(arenaName, worldName, posX, posY, posZ);
		
		Messages.send(Messages.arenaSuccessSetSpawn2, sender, Messages.ph("arena_name", arenaName));
	...
	//Check if spawn 1 is set, if not, send message
}
